...
def load_data():
    ...
    user_movie = {}
    for line in open(filename_user_movie, 'r'):
    ...
    for line in open(filename_movieInfo, 'r', encoding='ISO-8859-1'):
        (movieId, movieTitle, movieGenres) = line.split('::')
...
def calUserSim(user_movie):
    ...
    # calculate user similarity (Perason correlation coefficient)
    userSim = {}
    for u in C.keys():
